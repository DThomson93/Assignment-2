...
public class GUI implements ActionListener {
	...
	private static String[] horseTeams = { "Easy Goer", "Frankel", "Kincsem",
			...
			"Eclipse", "Funny Cide", "Gloaming", "Hyperion", "Iroquois",
			"Kelso", "Might and Power", "Red Rum", "Seabiscuit", "Totilas",
			"Vain", "War Admiral", "Zenyatta", "Affirmed", "Alydar", "Emperor" };
	private static String[] footTeams = { "Manchester United",
			"Manchester City", "Arsenal", "Chelsea", "Liverpool", "Barcelona",
			"Real Madrid", "A.C. Milan", "Bayern Munich", "Celtic" };
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnPlaceBet) {
			...
			if (betsMade.isEmpty()) {
					JOptionPane.showMessageDialog(null, "There is not bet in this slot.");
			} else {
				int n = JOptionPane
						.showOptionDialog(frame, bet1.getText(), "Edit Bet",
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet2.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet3.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet4.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet5.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet6.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet7.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet8.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet9.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
			...
			if (betsMade.isEmpty()) {
				...
				int n = JOptionPane
						.showOptionDialog(frame, bet10.getText(), "Edit Bet",
								JOptionPane.YES_NO_CANCEL_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[1]);
		...
		if (menu == "Place Bet") {
				...
				if (balAdd.getText() == "") {
					JOptionPane
							.showMessageDialog(null,
									"Please enter a value before attempting to add to your balance");
				} else if (addBal <= 0) {
					JOptionPane.showMessageDialog(null,
			...
			try {
				...
				if (choice == "") {
					JOptionPane
							.showMessageDialog(null,
									"Please select someone to bet on before attempting to place a bet.");
				} else {
					if (balance >= amount) {
						if (amount > 0) {
							if (sportStatus == "Horse") {
								...
								for (int j = 0; j < betsMade.size(); j++) {
									...
									if (hb.getType() == tempBet2.getType()) {
										JOptionPane
												.showMessageDialog(null,
														"You cannot bet on the same selection twice!");
										hbChecker = true;
									}
								}
								if (hbChecker == false) {
									...
									counter++;
									if (bet1.getText() == "") {
										bet1.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet2.getText() == "") {
										bet2.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet3.getText() == "") {
										bet3.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet4.getText() == "") {
										bet4.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet5.getText() == "") {
										bet5.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet6.getText() == "") {
										bet6.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet7.getText() == "") {
										bet7.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet8.getText() == "") {
										bet8.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet9.getText() == "") {
										bet9.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet10.getText() == "") {
										bet10.setText(hb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(hb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
										...
										JOptionPane
												.showMessageDialog(
														null,
														"You have reached your limit for number of bets made. Please remove a bet or wait until a bet result has come in before making another.");
									}
								}
								...
								if (fbChecker == false) {
									...
									counter++;
									if (bet1.getText() == "") {
										bet1.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet2.getText() == "") {
										bet2.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet3.getText() == "") {
										bet3.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet4.getText() == "") {
										bet4.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet5.getText() == "") {
										bet5.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet6.getText() == "") {
										bet6.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet7.getText() == "") {
										bet7.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet8.getText() == "") {
										bet8.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet9.getText() == "") {
										bet9.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet10.getText() == "") {
										bet10.setText(fb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(fb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
								...
								if (bbChecker == false) {
									...
									counter++;
									if (bet1.getText() == "") {
										bet1.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet2.getText() == "") {
										bet2.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet3.getText() == "") {
										bet3.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet4.getText() == "") {
										bet4.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet5.getText() == "") {
										bet5.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet6.getText() == "") {
										bet6.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet7.getText() == "") {
										bet7.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet8.getText() == "") {
										bet8.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet9.getText() == "") {
										bet9.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
									} else if (bet10.getText() == "") {
										bet10.setText(bb.getType()
												+ ", Amount: \u20AC"
												+ dec.format(bb.getAmount())
												+ ", Made at: "
												+ sdf.format(cal.getTime()));
								...
								JOptionPane
										.showMessageDialog(null,
												"You need to choose a sport and someone to bet on before submitting a bet");
							}
							choice = "";
						}
						...
						JOptionPane
								.showMessageDialog(
										null,
										"The amount entered exceeds your balance. Please enter a lower amount or add more money to your balance");
					}
				}
				enAmount.setText("");
				resetButtonStatus();
			...
			for (Bet bet1 : betsMade) {
				...
				if (bet1.getType().toLowerCase()
						.contains(searchBar.getText().toLowerCase())
						|| stri.contains(searchBar.getText().toLowerCase())) {
	...
	public void createReceipt() {
		...
		if (betsMade.isEmpty()) {
			JOptionPane.showMessageDialog(null,
					"You have made no bets, therefore there are no receipts!");
		} else {

			for (Bet bet : betsMade) {
				outputstream.println("You bet on: " + bet.getType()
						+ "\n Amount: €" + dec.format(bet.getAmount()) + " at: "
						+ sdf.format(cal.getTime()) + "\n");
			}
			outputstream.println("Balance at time of printing: €"
					+ dec.format(balance));
			JOptionPane.showMessageDialog(null, "Your bets have been cleared, and their results printed!");
			betsMade.clear();
			bet1.setText("");
			bet2.setText("");
			bet3.setText("");
